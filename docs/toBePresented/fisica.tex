...
\midrule
Superficie inmediata & \textsf{MUERTA} & UV por encima de la fluencia letal \\
Resto del subsuelo & \textsf{LATENTE} & el UV cae rápido y deja de matar; falta agua para crecer \\
\bottomrule
\end{tabular}
\end{center}
